...
public class AccountController {
    ...
    @GetMapping(value = "/accounts/{country}")
    public ResponseEntity<List<Account>> accountsByCountry(@PathVariable("country") String country) {
        List<Account> accounts = accountService.findAccountsByCountry(country);
